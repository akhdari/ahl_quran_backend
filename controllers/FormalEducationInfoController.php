...
require_once '../../models/FormalEducationInfo.php';
require_once '../../controllers/Controller.php';

class FormalEducationInfoController extends Controller
{
    
    public static function getAll() {
        try {
            $obj = FormalEducationInfo::getAll(self::$dbconnection);
    ...
    public static function getOne(int ...$id) {
        try {
            $obj = FormalEducationInfo::get(self::$dbconnection, (int)$id[0]);
          self::sendResponse(200, $obj);
        } catch (\Exception $e) {
            self::sendResponse(500, ['error' => 'Server error: ' . $e->getMessage()]);
        }
    ...
    public static function save() {
        ...
        if (!$data) return;
        try {
            $obj = FormalEducationInfo::create(self::$dbconnection, $data);
    ...
    public static function update(int ...$id) {
        ...
        try {
            $existing = FormalEducationInfo::get(self::$dbconnection, (int)$id[0]);
            if (!$existing) {
