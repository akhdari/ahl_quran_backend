...
require_once '../../models/SubscriptionInfo.php';
...
class SubscriptionInfoController extends Controller
{
    ...
    public static function getAll() {
        try {
            $obj = SubscriptionInfo::getAll(self::$dbconnection);
    ...
    public static function getOne(int ...$id) {
        try {
            $obj = SubscriptionInfo::get(self::$dbconnection, (int)$id[0]);
          self::sendResponse(200, $obj);
        } catch (\Exception $e) {
            self::sendResponse(500, ['error' => 'Server error: ' . $e->getMessage()]);
        }
    ...
    public static function save() {
        ...
        if (!$data) return;
        try {
            $obj = SubscriptionInfo::create(self::$dbconnection, $data);
    ...
    public static function update(int ...$id) {
        ...
        try {
            $existing = SubscriptionInfo::get(self::$dbconnection, (int)$id[0]);
            if (!$existing) {
