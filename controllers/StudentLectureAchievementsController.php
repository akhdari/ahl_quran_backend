...
require_once '../../models/StudentLectureAchievements.php';
require_once '../../controllers/Controller.php';

class StudentLectureAchievementsController extends Controller
{
    ...
    public static function save() {
        ...
        if (!$data) return;
        try {
            $obj = StudentLectureAchievements::create(self::$dbconnection, $data);
    ...
    public static function update(int ...$id) {
        ...
        try {
            $existing = StudentLectureAchievements::get(self::$dbconnection, (int)$id[0],  (int)$id[1]);
            if (!$existing) {
