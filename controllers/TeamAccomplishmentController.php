...
require_once '../../models/TeamAccomplishment.php';
require_once '../../controllers/Controller.php';

class TeamAccomplishmentController extends Controller
{
    
    public static function getAll() {
        try {
            $obj = TeamAccomplishment::getAll(self::$dbconnection);
    ...
    public static function save() {
        ...
        if (!$data) return;
        try {
            $obj = TeamAccomplishment::create(self::$dbconnection, $data);
