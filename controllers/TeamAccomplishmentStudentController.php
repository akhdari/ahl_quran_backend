...
require_once '../../models/TeamAccomplishmentStudent.php';
require_once '../../controllers/Controller.php';

class TeamAccomplishmentStudentController extends Controller
{
    
    public static function getAll() {
        try {
            $obj = TeamAccomplishmentStudent::getAll(self::$dbconnection);
    ...
    public static function getOne(int ...$id) {
        try {
            $obj = TeamAccomplishmentStudent::get(self::$dbconnection, (int)$id[0], (int)$id[1]);
          self::sendResponse(200, $obj);
        } catch (\Exception $e) {
            self::sendResponse(500, ['error' => 'Server error: ' . $e->getMessage()]);
        }
    ...
    public static function save() {
        ...
        if (!$data) return;
        try {
            $obj = TeamAccomplishmentStudent::create(self::$dbconnection, $data);
    ...
    public static function update(int ...$id) {
        ...
        try {
            $existing = TeamAccomplishmentStudent::get(self::$dbconnection, (int)$id[0], (int)$id[1]);
            if (!$existing) {
