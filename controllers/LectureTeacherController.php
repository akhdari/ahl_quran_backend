...
require_once '../../models/LectureTeacher.php';
...
class LectureTeacherController extends Controller
{
    ...
    public static function getAll() {
        try {
            $obj = LectureTeacher::getAll(self::$dbconnection);
    ...
    public static function getOne(int ...$id) {
        try {
            $obj = LectureTeacher::get(self::$dbconnection, (int)$id[0], (int)$id[1]);
          self::sendResponse(200, $obj);
        } catch (\Exception $e) {
            self::sendResponse(500, ['error' => 'Server error: ' . $e->getMessage()]);
        }
    ...
    public static function save() {
        ...
        if (!$data) return;
        try {
            $obj = LectureTeacher::create(self::$dbconnection, $data);
    ...
    public static function update(int ...$id) {
        ...
        try {
            $existing = LectureTeacher::get(self::$dbconnection, (int)$id[0], (int)$id[1]);
            if (!$existing) {
