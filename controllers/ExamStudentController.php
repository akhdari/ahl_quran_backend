...
require_once '../../models/ExamStudent.php';
...
class ExamStudentController extends Controller
{
    ...
    public static function getAll() {
        try {
            $obj = ExamStudent::getAll(self::$dbconnection);
    ...
    public static function getOne(int ...$id) {
        try {
            $obj = ExamStudent::get(self::$dbconnection, (int)$id[0], (int)$id[1]);
          self::sendResponse(200, $obj);
        } catch (\Exception $e) {
            self::sendResponse(500, ['error' => 'Server error: ' . $e->getMessage()]);
        }
    ...
    public static function save() {
        ...
        if (!$data) return;
        try {
            $obj = ExamStudent::create(self::$dbconnection, $data);
    ...
    public static function update(int ...$id) {
        ...
        try {
            $existing = ExamStudent::get(self::$dbconnection, (int)$id[0], (int)$id[1]);
            if (!$existing) {
