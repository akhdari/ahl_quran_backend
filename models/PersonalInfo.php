<?php 
    ...
    class PersonalInfo {
		...
		/** @var mixed $first_name_ar */
		public $first_name_ar;

		/** @var mixed $last_name_ar */
		public $last_name_ar;

		/** @var mixed $first_name_en */
		public $first_name_en;

		/** @var mixed $last_name_en */
		public $last_name_en;

		/** @var mixed $nationality */
		public $nationality;
		...
		/** @var mixed $place_of_birth */
		public $place_of_birth;

		/** @var mixed $home_address */
		public $home_address;

		/** @var mixed $father_status */
		public $father_status;

		/** @var mixed $mother_status */
